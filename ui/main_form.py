...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.x_input = QtWidgets.QLineEdit(self.frame_16)
        self.x_input.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.x_input.setText("")
        self.x_input.setMaxLength(13)
        self.x_input.setAlignment(QtCore.Qt.AlignCenter)
        self.x_input.setObjectName("x_input")
        self.horizontalLayout_14.addWidget(self.x_input)
        self.verticalLayout_9.addWidget(self.frame_16)
        self.frame_17 = QtWidgets.QFrame(self.groupBox_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.y_input = QtWidgets.QLineEdit(self.frame_17)
        self.y_input.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.y_input.setText("")
        self.y_input.setMaxLength(13)
        self.y_input.setCursorPosition(0)
        self.y_input.setAlignment(QtCore.Qt.AlignCenter)
        self.y_input.setObjectName("y_input")
        self.horizontalLayout_15.addWidget(self.y_input)
        self.verticalLayout_9.addWidget(self.frame_17)
        self.vehicle_tp = QtWidgets.QPushButton(self.groupBox_3)
        self.vehicle_tp.setObjectName("vehicle_tp")
        self.verticalLayout_9.addWidget(self.vehicle_tp)
        ...
        self.tank_protect = QtWidgets.QPushButton(self.groupBox_9)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(20)
        self.tank_protect.setFont(font)
        self.tank_protect.setStyleSheet("background: rgb(255, 255, 127); color:blue;")
        self.tank_protect.setObjectName("tank_protect")
        self.gridLayout.addWidget(self.tank_protect, 3, 2, 1, 1)
        ...
        self.protect_label = QtWidgets.QLabel(self.frame_15)
        self.protect_label.setObjectName("protect_label")
        self.horizontalLayout_13.addWidget(self.protect_label)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "Координаты:"))
        self.label_8.setText(_translate("MainWindow", "X:"))
        self.x_input.setPlaceholderText(_translate("MainWindow", "0"))
        self.label_17.setText(_translate("MainWindow", "Y:"))
        self.y_input.setPlaceholderText(_translate("MainWindow", "0"))
        self.vehicle_tp.setText(_translate("MainWindow", "Применить"))
        self.groupBox_7.setTitle(_translate("MainWindow", "Параметры Пс-Ш:"))
        ...
        self.coord_label.setText(_translate("MainWindow", "0.00, 0.00"))
        ...
        self.tank_protect.setText(_translate("MainWindow", "ЗАЩИТА!"))
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "Параметры защиты:"))
        self.label_7.setText(_translate("MainWindow", "Зарядов (шт):"))
        self.protect_label.setText(_translate("MainWindow", "0"))
